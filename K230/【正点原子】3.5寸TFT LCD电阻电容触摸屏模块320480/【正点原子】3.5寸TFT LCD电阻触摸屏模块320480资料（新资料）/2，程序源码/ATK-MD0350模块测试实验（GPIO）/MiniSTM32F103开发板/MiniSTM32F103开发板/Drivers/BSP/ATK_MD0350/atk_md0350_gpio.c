...
#include "./BSP/ATK_MD0350/atk_md0350_gpio.h"
...
void atk_md0350_gpio_init(void)
{
    ...
    /* 使能时钟 */
    ATK_MD0350_GPIO_RS_GPIO_CLK_ENABLE();
    ATK_MD0350_GPIO_CS_GPIO_CLK_ENABLE();
    ATK_MD0350_GPIO_RD_GPIO_CLK_ENABLE();
    ATK_MD0350_GPIO_WR_GPIO_CLK_ENABLE();
    ATK_MD0350_GPIO_DATA_GPIO_CLK_ENABLE();
